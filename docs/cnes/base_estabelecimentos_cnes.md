...
- `Sim`: quando `atendimento_prestado` ou `convenio` contém texto com "SUS".
- `Revisar`: demais casos (incluindo ausência de informação).
...
- Se não versionado por tamanho, deve ser gerado localmente via script.
